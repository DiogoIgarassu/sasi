# Generated by Django 3.0.8 on 2020-07-19 02:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=30, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@+-]+$'), 'O nome de usuário só pode contar letras, números ou seguintes caracteres: @/./+/-/_', 'invalid')], verbose_name='Nome de Usuário')),
